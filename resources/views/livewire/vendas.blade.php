            ...
            <table class="table-fixed w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <button wire:click="edit({{ $venda->id }})" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Editar</button>
                            <button wire:click="delete({{ $venda->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Excluir</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
